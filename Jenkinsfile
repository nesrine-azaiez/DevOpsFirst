                ...
                stage('SonarQube stage') {
                 ...
                 stage('MVN PACKAGE'){
                              steps{
                               ...
                               stage("NEXUS"){
                                                                                 steps{
                                                                                         sh 'mvn deploy:deploy-file -DgroupId=tn.esprit.rh -DartifactId=achat -Dversion=4.0-SNAPSHOT -DgeneratePom=true -Dpackaging=jar -DrepositoryId=deploymentRepo -Durl=http://192.168.1.188:8081//repository/maven-snapshots -Dfile=target/docker-spring-boot.jar'
                                                                                         }
                                                                  }
