                ...
                stage('SonarQube stage') {
                 ...
                 stage('MVN PACKAGE'){
                              steps{
                               ...
                               stage("NEXUS"){
                                                                                 steps{
                                                                                         sh 'mvn deploy:deploy-file -DgroupId=tn.esprit.rh -DartifactId=achat -Dversion=1.0 -DgeneratePom=true -Dpackaging=jar -DrepositoryId=deploymentRepo -Durl=http://192.168.1.199:8081/repository/maven-releases -Dfile=target/docker-spring-boot.jar'
                                                                                         }
                                                                  }
                    /*  stage("nexus deploy"){
                                  steps{
